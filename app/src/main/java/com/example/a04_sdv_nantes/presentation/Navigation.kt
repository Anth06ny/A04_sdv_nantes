package com.example.a04_sdv_nantes.presentation
...
import com.example.a04_sdv_nantes.presentation.ui.screens.DetailScreen
...
fun AppNavigation(modifier: Modifier = Modifier) {
    ...
    NavHost(
        ...
        composable<Routes.SearchRoute> {
            ...
            SearchScreen(navHostController = navHostController, viewModel = mainViewModel)
        }
